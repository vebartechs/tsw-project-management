        ...
        <form id="projectForm" class="row mt-3" method="POST" action="{{ route('project.store') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-2">
                    ...
                    <input type="number" class="form-control" id="daysInput" name="days" min="1" max="10" required>
                </div>
                <div class="col-md-2 mb-2">
            ...
            <div class="card mb-3 border">
                ...
                <div class="card-body">
                    <div class="row g-3 align-items-center mb-2">
                        <div class="col-auto">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="complimentary[drone_option]" value="drone" id="droneOption">
                                <label class="form-check-label" for="droneOption">Drone</label>
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="complimentary[drone_option]" value="no_drone" id="noDroneOption">
                    ...
                    <div class="form-check mb-3">
                        <input type="checkbox" class="form-check-input" name="complimentary[pre_wedding]" value="1" id="preWeddingCheck">
                        <label class="form-check-label" for="preWeddingCheck">Pre Wedding</label>
                    </div>

                    <div class="row g-3 align-items-center">
                        <div class="col-md-3">
                            <label for="complimentaryType" class="form-label">Type</label>
                            <select name="complimentary[type]" class="form-select" id="complimentaryType">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="complimentary[photographers]" class="form-control" id="photographersInput">
                        </div>
                        <div class="col-md-3">
                            <label for="videographersInput" class="form-label">No of Videographer</label>
                            <input type="number" name="complimentary[videographers]" class="form-control" id="videographersInput">
                        </div>
                        <div class="col-md-3">
                            <label for="complimentaryLocation" class="form-label">Location</label>
                            <select name="complimentary[location]" class="form-select" id="complimentaryLocation">
